...
CREATE POLICY "Allow all operations for authenticated users" ON "public"."order" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Allow all operations for authenticated users" ON "public"."order_item" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "Enable read access for authenticated users" ON "public"."category" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Enable update for authenticated users" ON "public"."product" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
